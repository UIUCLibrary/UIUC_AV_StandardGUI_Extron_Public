...
def SystemSettings_init():
	return extronlib_impl.SystemSettings()

init_dict={ "extronlib.SystemSettings" : SystemSettings_init,
"extronlib.device.SystemSettings" : SystemSettings_init,
"extronlib.device.utils.SystemSettings" : SystemSettings_init}
