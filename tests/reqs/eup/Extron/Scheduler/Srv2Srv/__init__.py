...
import extron_impl
def GoogleJWT_init():
	return extron_impl.GoogleJWT()

init_dict={ "Extron.GoogleJWT" : GoogleJWT_init,
"Extron.Scheduler.GoogleJWT" : GoogleJWT_init,
"Extron.Scheduler.Srv2Srv.GoogleJWT" : GoogleJWT_init}
